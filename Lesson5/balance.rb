...
puts "Курс доллара:"
rate = gets.chomp.to_f.round(2)
puts "Сколько у вас рублей?"
rubles = gets.chomp.to_f.round(2)
puts "Сколько у вас долларов?"
dollars = gets.chomp.to_f.round(2)

# Переводим доллары в рубли и проверяем условие баланса в центах
dollars_to_rubles = (dollars * rate).round(2)
if (rubles - dollars_to_rubles).abs < 0.01
	...
	puts "Вам нужно продать #{(sell / rate).round(4)}$"
end	
