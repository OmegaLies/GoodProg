class Game
  ...
  def letters_to_guess
    result =
      @letters.map do |letter|
        if @user_guesses.include?(normlize_letter(letter))
          letter
        else
          nil
        end
  ...
  def won?
    (normlize_letters - @user_guesses).empty?
  end
  ...
  def normlize_letters
    @letters.map{ |letter| normlize_letter(letter) }
  end
end
